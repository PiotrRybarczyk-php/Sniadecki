    ...
    <div class="br-mainpanel">
      <div class="pd-30">
        <h4 class="tx-gray-800 mg-b-5">Kategorie</h4>
              ...
              foreach ($rows as $value) : $i++; ?>
                <tr>
                  ...
                  <td class="text-right">
                    ...
                    <a href="categories/sub_index/subcat/<?= $value->id; ?>" class="btn btn-sm btn-secondary">
                      <i class="icon ion-compose mg-r-10"></i> Podkategorie
                    </a>
                  </td>
                </tr>
              <?php endforeach; ?>
