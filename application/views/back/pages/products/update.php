                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 pr-0">
                                <div class="form-group">
                                    <label class="form-control-label">Nazwa Produktu: <span class="tx-danger">*</span></label>
                        ...
                        <div class="row">
                            <div class="col-md-12 pr-0">
                                <div class="form-group bd-t-0-force">
                                    <label for="category" class="form-control-label">Wybierz Kategorie i Podkategorie: <span class="tx-danger">*</span></label>
                                    <select class="form-control" id="category" name="sub_id">
                                        <?php foreach ($subcat as $element) : ?>
                                            <option <?php if ($value->sub_id == $element->id) echo 'selected'; ?> value="<?= $element->id; ?>"><?= $cat[$element->cat_id - 1]->title . ' / ' . $element->title; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                            </div><!-- col-4 -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 pr-0">
                                <div class="form-group bd-t-0-force bd-b-0-force">
                                    <label class="form-control-label">Opis Produktu:</label>
                                    <textarea class="summernote" name="description"><?= $value->description; ?></textarea>
                                </div>
                            </div>
                            <!-- col-4 -->
                        </div> <!-- set -->
